...
def eval_doc(gold_ann,preds,entity_pool):
    ...
    for gold in gold_ann:
        ...
        #If there is a match
        if match_index != -1:
            #We have a true positive if one of the entities is None
            if (preds[match_index][2] == 'None') or (gold[2] == 'None'):
